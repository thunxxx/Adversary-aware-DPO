...
class FinetuningArguments(
    ...
    stage: Literal["pt", "sft", "rm", "ppo", "dpo", "kto", "adpo", "at", "lat", "ladpo"] = field(
        default="sft",
    ...
    AT_alpha: float = field(
        default=1,
         metadata={"help": "Alpha for adversarial training."}
    )
    ...
    def __post_init__(self):
        ...
        self.use_ref_model = (self.stage == "dpo" and self.pref_loss not in ["orpo", "simpo"]) or self.stage == "adpo" or self.stage == "ladpo"
